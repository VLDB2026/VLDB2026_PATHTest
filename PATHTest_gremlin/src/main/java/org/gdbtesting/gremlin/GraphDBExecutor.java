...
public class GraphDBExecutor {
    ...
    public void executeQuery(GremlinConnection connection, int count) throws IOException {
        String cur = System.getProperty("period");
        BufferedWriter out = new BufferedWriter(new FileWriter(System.getProperty("user.dir") + "/log-" + cur + "/" + connection.getDatabase()+ "-" + cur +".log"));
    ...
    public void setupGraph(List<GraphData.VertexObject> addV, List<GraphData.EdgeObject> addE) throws IOException {
    ...
    public void recordDBMap() throws IOException {
        for(GremlinConnection connection: connections){
            String cur = System.getProperty("period");
            BufferedWriter out = new BufferedWriter(new FileWriter(System.getProperty("user.dir") + "/log-" + cur + "/" + cur +"-Map-"+".log"));

...
import org.example.PATHTest.cypher.schema.IPatternElementInfo;
...
public abstract class CypherSchemaGenerator <S extends CypherSchema<G,?>, G extends CypherGlobalState<?, S>>{
    ...
    public S generateSchema() throws Exception {
    ...
    public abstract S generateSchemaObject(G globalState,
            ...
            List<CypherSchema.CypherPatternInfo> patternInfos) throws Exception;
}

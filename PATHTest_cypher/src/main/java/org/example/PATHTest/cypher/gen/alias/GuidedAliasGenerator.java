package org.example.PATHTest.cypher.gen.alias;

import org.example.PATHTest.Randomly;
import org.example.PATHTest.cypher.ast.analyzer.*;
...
import org.example.PATHTest.cypher.standard_ast.expr.GetPropertyExpression;
import org.example.PATHTest.cypher.standard_ast.expr.IdentifierExpression;
import org.example.PATHTest.cypher.dsl.BasicAliasGenerator;
...
//                }
        ...
        withClause.setDistinct(false); //todo 由于union变异操作的存在，不能生成DISTINCT语句
        /*if (Randomly.getBooleanWithRatherLowProbability()) {

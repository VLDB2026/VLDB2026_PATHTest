...
public class NebulaSchema extends CypherSchema<NebulaGlobalState, NebulaSchema.NebulaTable> {


    public NebulaSchema(List<NebulaTable> databaseTables, List<CypherLabelInfo> labels,
    ...
    public List<IFunctionInfo> getFunctions() {
        return Arrays.asList(NebulaSchema.NebulaBuiltInFunctions.values());
    }

    public enum NebulaBuiltInFunctions implements IFunctionInfo{
        ...
        NebulaBuiltInFunctions(String name, String signature, CypherType expectedReturnType, IParamInfo... params){
            this.name = name;
    ...
    public static class NebulaTable extends AbstractTable<NebulaSchema.NebulaTableColumn, TableIndex, NebulaGlobalState> {

        //todo complete
        public NebulaTable(String name, List<NebulaSchema.NebulaTableColumn> columns, List<TableIndex> indexes, boolean isView) {
            super(name, columns, indexes, isView);
        }

        @Override
        public long getNrRows(NebulaGlobalState globalState) {
            return 0;
        }
    }

    public static class NebulaTableColumn extends AbstractTableColumn<NebulaSchema.NebulaTable, NebulaSchema.NebulaDataType> {
        //todo complete
        public NebulaTableColumn(String name, NebulaSchema.NebulaTable table, NebulaSchema.NebulaDataType type) {
